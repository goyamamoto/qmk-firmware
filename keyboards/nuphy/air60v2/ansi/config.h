...
// the IME mod-taps beside Space act as the modifier as soon as another key is pressed
...
// Give up on an unresponsive LED driver quickly so a stuck bus cannot stall
// the main loop (24 transfers per frame). The stock firmware used 1 ms via the
// old ISSI_TIMEOUT name; a transfer takes about 0.2 ms at 1 MHz.
#define IS31FL3733_I2C_TIMEOUT 5
...
#define NUPHY_BLE_NAME "NuPhy Air60 V2"
#define NUPHY_24G_NAME "NuPhy Air60 V2 Dongle"

// no ambient light on the Air60 V2
...
// Air60 V2 has no F-row, Win Lock or Num Lock key:
// light the left Win key for Win Lock, Esc for Num Lock,
// and show two-digit tens on the Q row (Tab = 0, Q = 1 ... P = 10).
// Caps Lock sits on the Left Ctrl position (the base layers swap them)
#define CAPS_LOCK_ROW 5
#define CAPS_LOCK_COL 0
#define WIN_LOCK_ROW 5
#define WIN_LOCK_COL 1
#define NUM_LOCK_ROW 0
#define NUM_LOCK_COL 0
#define NUPHY_TENS_DIGIT_ROW 2
/*
